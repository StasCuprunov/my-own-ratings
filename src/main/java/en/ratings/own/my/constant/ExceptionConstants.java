...
public final class ExceptionConstants {
    ...
    public static final String KEY_RATING_NAME_IS_TOO_LONG = "ratingNameIsTooLong";
    public static final String KEY_RATING_NAME_ALREADY_USED_FOR_USER = "ratingNameAlreadyUsedForUser";
    public static final String KEY_RATING_DESCRIPTION_TOO_LONG = "ratingDescriptionTooLong";
    ...
    public static final String KEY_RATING_ENTRY_NAME_IS_TOO_LONG = "ratingEntryNameIsTooLong";
